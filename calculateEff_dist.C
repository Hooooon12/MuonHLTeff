...
void calculateEff_dist(TString input, TString output){
  ...
  //===============================Call needed objects=======================================//
    ...
    //    Object IOFromL1Track;
    //    IOFromL1Track.SetPtEtaPhiM(hltIter0IterL3FromL1MuonTrack_pt->at(j),hltIter0IterL3FromL1MuonTrack_eta->at(j),hltIter0IterL3FromL1MuonTrack_phi->at(j),0);
    //    IOFromL1Track.SetTag("IOFromL1");
    //    IOFromL1Track.SetTruePU(truePU);
    //    IOFromL1Tracks.push_back(IOFromL1Track);
    //    cout << "iterL3IOFromL1_pt: " << hltIter0IterL3FromL1MuonTrack_pt->at(j) << endl;
    //  }
    //  for(int j=0; j<nhltIter2IterL3FromL1MuonTrack; j++){
    //    Object IOFromL1Track;
    //    IOFromL1Track.SetPtEtaPhiM(hltIter2IterL3FromL1MuonTrack_pt->at(j),hltIter2IterL3FromL1MuonTrack_eta->at(j),hltIter2IterL3FromL1MuonTrack_phi->at(j),0);
    //    IOFromL1Track.SetTag("IOFromL1");
    //    IOFromL1Track.SetTruePU(truePU);
    //    IOFromL1Tracks.push_back(IOFromL1Track);
    //    cout << "iterL3IOFromL1_pt: " << hltIter2IterL3FromL1MuonTrack_pt->at(j) << endl;
    //  }
    //}
    else if(output.Contains("Winter21")){
  ...
  //==========================================Purity====================================================//
    ...
    do_purity(IOFromL1Tracks, Finals, 0.1, genEventWeight);
